...
fn main() {
    ...
    // game_rnd_constraint(game_no, bool_know_priv_info, print_frequency, log_bool);
    {
        ...
        use Card::*;
        let replay = vec![Income { player_id: 0 }, Income { player_id: 1 }, Steal { player_id: 2, opposing_player_id: 4, amount: 2 }, CollectiveChallenge { participants: [true, false, false, true, false, true], opposing_player_id: 2, final_actioner: 5 }, Discard { player_id: 2, card: [Contessa, Contessa], no_cards: 1 }, Steal { player_id: 3, opposing_player_id: 0, amount: 2 }, CollectiveChallenge { participants: [true, true, true, false, false, false], opposing_player_id: 3, final_actioner: 0 }, Discard { player_id: 3, card: [Contessa, Contessa], no_cards: 1 }, Steal { player_id: 4, opposing_player_id: 2, amount: 2 }, CollectiveChallenge { participants: [false, false, true, true, false, true], opposing_player_id: 4, final_actioner: 2 }, Discard { player_id: 4, card: [Contessa, Contessa], no_cards: 1 }, ForeignAid { player_id: 5 }, CollectiveBlock { participants: [true, true, true, true, true, false], opposing_player_id: 5, final_actioner: 1 }, CollectiveChallenge { participants: [true, false, false, true, false, true], opposing_player_id: 1, final_actioner: 3 }, RevealRedraw { player_id: 1, card: Duke }, Discard { player_id: 3, card: [Ambassador, Ambassador], no_cards: 1 }, Steal { player_id: 0, opposing_player_id: 1, amount: 2 }, CollectiveChallenge { participants: [false, false, true, false, true, true], opposing_player_id: 0, final_actioner: 5 }, Discard { player_id: 0, card: [Assassin, Assassin], no_cards: 1 }, Assassinate { player_id: 1, opposing_player_id: 5 }, CollectiveChallenge { participants: [true, false, false, false, false, true], opposing_player_id: 1, final_actioner: 0 }, Discard { player_id: 1, card: [Captain, Captain], no_cards: 1 }, Steal { player_id: 2, opposing_player_id: 5, amount: 2 }, CollectiveChallenge { participants: [true, true, false, false, true, false], opposing_player_id: 2, final_actioner: 4 }, RevealRedraw { player_id: 2, card: Captain }, Discard { player_id: 4, card: [Assassin, Assassin], no_cards: 1 }, BlockSteal { player_id: 5, opposing_player_id: 2, card: Ambassador }, CollectiveChallenge { participants: [true, true, false, false, false, false], opposing_player_id: 5, final_actioner: 0 }, Discard { player_id: 5, card: [Assassin, Assassin], no_cards: 1 }, Tax { player_id: 5 }, CollectiveChallenge { participants: [false, false, true, false, false, false], opposing_player_id: 5, final_actioner: 2 }, Discard { player_id: 5, card: [Ambassador, Ambassador], no_cards: 1 }, Income { player_id: 0 }, ForeignAid { player_id: 1 }, CollectiveBlock { participants: [true, false, true, false, false, false], opposing_player_id: 1, final_actioner: 2 }, CollectiveChallenge { participants: [true, true, false, false, false, false], opposing_player_id: 2, final_actioner: 0 }, Discard { player_id: 2, card: [Captain, Captain], no_cards: 1 }, ForeignAid { player_id: 0 }, CollectiveBlock { participants: [false, true, false, false, false, false], opposing_player_id: 0, final_actioner: 1 }, CollectiveChallenge { participants: [false, false, false, false, false, false], opposing_player_id: 1, final_actioner: 1 }, Exchange { player_id: 1 }, CollectiveChallenge { participants: [true, false, false, false, false, false], opposing_player_id: 1, final_actioner: 0 }, RevealRedraw { player_id: 1, card: Ambassador }, Discard { player_id: 0, card: [Captain, Captain], no_cards: 1 }];
