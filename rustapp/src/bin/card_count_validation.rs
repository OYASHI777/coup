    ...
    while game < game_no {
        ...
        while !hh.game_won() {
            ...
            if total_dead >= min_dead_check {
                ...
                let validated_impossible_constraints_2 = *prob.player_impossible_constraints_paired();
                let validated_impossible_constraints_3 = *prob.player_impossible_constraints_triple();
