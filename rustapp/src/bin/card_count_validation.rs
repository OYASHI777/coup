...
pub fn bt_test() {
    ...
    let amb_0 = vec![Steal { player_id: 0, opposing_player_id: 3, amount: 2 }, CollectiveChallenge { participants: [false, false, false, false, true, false], opposing_player_id: 0, final_actioner: 4 }, RevealRedraw { player_id: 0, card: Captain }, Discard { player_id: 4, card: [Assassin, Assassin], no_cards: 1 }, BlockSteal { player_id: 3, opposing_player_id: 3, card: Captain }, Steal { player_id: 1, opposing_player_id: 5, amount: 2 }, CollectiveChallenge { participants: [true, false, true, false, true, true], opposing_player_id: 1, final_actioner: 2 }, Discard { player_id: 1, card: [Ambassador, Ambassador], no_cards: 1 }, ForeignAid { player_id: 2 }, CollectiveBlock { participants: [true, true, false, false, false, true], opposing_player_id: 2, final_actioner: 0 }, CollectiveChallenge { participants: [false, false, true, true, true, true], opposing_player_id: 0, final_actioner: 2 }, RevealRedraw { player_id: 0, card: Duke }, Discard { player_id: 2, card: [Contessa, Contessa], no_cards: 1 }, Steal { player_id: 3, opposing_player_id: 4, amount: 2 }, CollectiveChallenge { participants: [false, false, true, false, true, false], opposing_player_id: 3, final_actioner: 2 }, Discard { player_id: 3, card: [Contessa, Contessa], no_cards: 1 }, ForeignAid { player_id: 4 }, CollectiveBlock { participants: [true, false, true, true, false, false], opposing_player_id: 4, final_actioner: 2 }, CollectiveChallenge { participants: [false, false, false, true, true, true], opposing_player_id: 2, final_actioner: 5 }, Discard { player_id: 2, card: [Assassin, Assassin], no_cards: 1 }, Steal { player_id: 5, opposing_player_id: 4, amount: 2 }, CollectiveChallenge { participants: [true, true, false, false, true, false], opposing_player_id: 5, final_actioner: 1 }, RevealRedraw { player_id: 5, card: Captain }, Discard { player_id: 1, card: [Duke, Duke], no_cards: 1 }, BlockSteal { player_id: 4, opposing_player_id: 5, card: Ambassador }, CollectiveChallenge { participants: [true, false, false, false, false, true], opposing_player_id: 4, final_actioner: 5 }, Discard { player_id: 4, card: [Duke, Duke], no_cards: 1 }, Exchange { player_id: 0 }, CollectiveChallenge { participants: [false, false, false, true, false, false], opposing_player_id: 0, final_actioner: 3 }, RevealRedraw { player_id: 0, card: Ambassador }, Discard { player_id: 3, card: [Ambassador, Ambassador], no_cards: 1 }, ExchangeDraw { player_id: 0, card: [Duke, Contessa] }, ExchangeChoice { player_id: 0, no_cards: 2 }, Exchange { player_id: 5 }, CollectiveChallenge { participants: [false, false, false, false, false, false], opposing_player_id: 5, final_actioner: 5 }, ExchangeDraw { player_id: 5, card: [Captain, Contessa] }];
