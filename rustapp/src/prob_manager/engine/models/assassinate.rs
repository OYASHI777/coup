        ...
        match action {
            ActionObservation::CollectiveChallenge {
                ...
                match opposing_player_id == final_actioner {
                    true => {
                        // No Challenger
                        EngineState::AssassinateInvitesBlock(AssassinateInvitesBlock {
                            player_turn: self.player_turn,
                            player_blocking: self.player_blocking,
                        })
                    }
                    false => EngineState::AssassinateChallenged(AssassinateChallenged {
                        player_turn: self.player_turn,
                        player_blocking: self.player_blocking,
...
impl CoupTransition for AssassinateInvitesBlock {
    ...
    fn state_leave_update(
        ...
        match (game_data.influence()[self.player_blocking], action) {
            (0, _) => EngineState::TurnStart(TurnStart {
                player_turn: self.player_turn,
            }),
            (
                1,
            ...
            | (
                ...
                match player_id == opposing_player_id {
                    true => {
                        // No Block
                        EngineState::AssassinateSucceeded(AssassinateSucceeded {
                            player_turn: self.player_turn,
                            player_blocking: self.player_blocking,
                        })
                    }
            ...
            _ => {
                panic!(
                    "Illegal! player lives: {}, for player: {}",
                    game_data.influence()[self.player_blocking],
        ...
        match action {
            ActionObservation::CollectiveChallenge {
                ...
                match opposing_player_id == final_actioner {
                    ...
                    false => EngineState::AssassinateBlockChallenged(AssassinateBlockChallenged {
                        player_turn: self.player_turn,
                        player_blocking: self.player_blocking,
                        player_challenger: *final_actioner,
                    }),
    ...
    fn state_leave_update(
        ...
        match action {
            ActionObservation::RevealRedraw { .. } => {
                EngineState::AssassinateBlockChallengerFailed(AssassinateBlockChallengerFailed {
                    player_turn: self.player_turn,
...
impl CoupTransition for AssassinateChallenged {
    ...
    fn state_leave_update(
        ...
        match action {
            ActionObservation::RevealRedraw { .. } => {
                EngineState::AssassinateChallengerFailed(AssassinateChallengerFailed {
                    player_turn: self.player_turn,
                    player_blocking: self.player_blocking,
                    player_challenger: self.player_challenger,
                })
        ...
        match action {
            ...
            ActionObservation::Discard {
                ...
                if *player_id == self.player_blocking {
                    ...
                    match game_data.game_will_be_won(*player_id, *no_cards as u8) {
                        true => EngineState::End(End {}),
                        false => EngineState::AssassinateInvitesBlock(AssassinateInvitesBlock {
                            player_turn: self.player_turn,
                            player_blocking: self.player_blocking,
                        }),
                    }
